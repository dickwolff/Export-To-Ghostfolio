...
import {XtbConverterV2} from "./converters/xtbConverterV2";
...
async function createConverter(converterType: string, securityService?: SecurityService): Promise<AbstractConverter> {
    ...
    switch (converterType) {
        ...
        case "xtb":
            ...
            break;
        case "xtb-v2":
            console.log("[i] Processing file using XTB converter V2 (new 2025+ Cash Operations format)");
            converter = new XtbConverterV2(securityService);
            break;
        default:
